...
build {
  ...
  post-processors {
    ...
    post-processor "vagrant-cloud" {
      box_tag = "geerlingguy/ubuntu2004"
      version = "${var.version}"
    }
  }
}
